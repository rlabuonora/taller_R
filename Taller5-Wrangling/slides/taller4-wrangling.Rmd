...
```{r}
library(dplyr)
msleep <- read.csv("../../Taller5-Wrangling/data/msleep_ggplot2.csv")
msleep %>%
...
```{r}
load("ipi.rdata")
View(cnbcu.seccion %>% arrange(desc.cnbcu.seccion, year))
View(cnbcu.subseccion %>% arrange(desc.cnbcu.subseccion, year))
```
